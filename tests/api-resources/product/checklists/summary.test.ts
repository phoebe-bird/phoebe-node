...
describe('resource summary', () => {
  test('retrieve', async () => {
    const responsePromise = phoebe.product.checklists.summary.retrieve('string', 0, 1, 1);
  ...
  test('retrieve: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      phoebe.product.checklists.summary.retrieve('string', 0, 1, 1, { path: '/_stainless_unknown_path' }),
