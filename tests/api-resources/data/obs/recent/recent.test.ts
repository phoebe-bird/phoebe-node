...
describe('resource recent', () => {
  test('list', async () => {
    const responsePromise = phoebe.data.obs.recent.list('string');
  ...
  test('list: request options instead of params are passed correctly', async () => {
    ...
    await expect(phoebe.data.obs.recent.list('string', { path: '/_stainless_unknown_path' })).rejects.toThrow(
