import fs from 'fs';
import type { ResponseLike } from 'phoebe-ebird/internal/to-file';
import { toFile } from 'phoebe-ebird/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('phoebe-ebird/core/uploads');
    await expect(
