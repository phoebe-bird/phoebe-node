...
import { Phoebe, ClientOptions } from 'phoebe-ebird';
...
function getTSDiagnostics(code: string): string[] {
  ...
  const codeWithImport = [
    ...
    functionSource.type === 'declaration' ?
      `async function run(${functionSource.client}: Phoebe)`
    : `const run: (${functionSource.client}: Phoebe) => Promise<unknown> =`,
    functionSource.code,
  ].join('\n');
...
const fuse = new Fuse(
  [
    ...
    'client.data.observations.geo.recent.list',
    'client.data.observations.geo.recent.species.list',
    'client.data.observations.geo.recent.notable.list',
    'client.data.observations.nearest.geoSpecies.list',
    ...
    'client.product.speciesList.list',
    'client.product.checklist.view',
    'client.ref.region.adjacent.list',
    'client.ref.region.info.retrieve',
    'client.ref.region.list.list',
    'client.ref.hotspot.list',
    'client.ref.hotspot.geo.retrieve',
    'client.ref.hotspot.info.retrieve',
    'client.ref.taxonomy.ebird.retrieve',
    'client.ref.taxonomy.forms.list',
    'client.ref.taxonomy.locales.list',
    'client.ref.taxonomy.versions.list',
