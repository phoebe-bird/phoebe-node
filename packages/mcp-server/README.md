...
[Open VS Code](https://vscode.stainless.com/mcp/%7B%22name%22%3A%22phoebe-ebird-mcp%22%2C%22command%22%3A%22npx%22%2C%22args%22%3A%5B%22-y%22%2C%22phoebe-ebird-mcp%22%5D%2C%22env%22%3A%7B%22EBIRD_API_KEY%22%3A%22My%20API%20Key%22%7D%7D)
...
```
claude mcp add phoebe_ebird_mcp_api --env EBIRD_API_KEY="My API Key" -- npx -y phoebe-ebird-mcp
```
