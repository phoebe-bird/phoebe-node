...
```sh
git clone git@github.com:stainless-sdks/phoebe-typescript.git
...
> [!NOTE]
> Once this package is [published to npm](https://app.stainless.com/docs/guides/publish), this will become: `npx -y phoebe-mcp`
...
```json
{
  "mcpServers": {
    "phoebe_ebird_api": {
      "command": "npx",
      "args": ["-y", "/path/to/local/phoebe-typescript/packages/mcp-server", "--client=claude"],
      "env": {
