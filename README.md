...
[![NPM version](https://img.shields.io/npm/v/phoebe-ebird.svg)](https://npmjs.org/package/phoebe-ebird) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/phoebe-ebird)
...
```sh
npm install git+ssh://git@github.com:stainless-sdks/phoebe-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://app.stainless.com/docs/guides/publish), this will become: `npm install phoebe-ebird`
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/phoebe-typescript/issues) with questions, bugs, or suggestions.
